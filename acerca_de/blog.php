...
<head>
    <meta charset="utf-8" />
    <title>Blog | Gas de Provincia</title>
    ...
    <meta name="description" content="Descubre artículos informativos y consejos sobre el uso de gas LP, seguridad y eficiencia en nuestro blog de Gas de Provincia." />

    <!-- Open Graph para redes sociales -->
    <meta property="og:title" content="Blog | Gas de Provincia" />
    <meta property="og:description" content="Descubre artículos informativos y consejos sobre el uso de gas LP, seguridad y eficiencia en nuestro blog de Gas de Provincia." />
    <meta property="og:url" content="https://www.gasdeprovinciahidalgo.com.mx/blog" />
    ...
    <meta name="twitter:title" content="Blog | Gas de Provincia" />
    <meta name="twitter:description" content="Descubre artículos informativos y consejos sobre el uso de gas LP, seguridad y eficiencia en nuestro blog de Gas de Provincia." />
                    ...
                    <div class="inner-container text-center" style="margin-top:0px;margin-bottom:0px;">
                        ...
                        <div class="parent-container">
                            <div class="text-window-container background-color-white">
                                <h1 class="type-display text-elevated text-window width-1200 centered text-center">Blog</h1>
                            </div>
