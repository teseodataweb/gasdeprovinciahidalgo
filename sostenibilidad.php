...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sostenibilidad | Gas de Provincia</title>
...
<body class="body-who-we-are" ontouchstart="">
    ...
    <div id="main-wrapper" class="container-fluid">
        ...
        <div>
            <p>En Gas de Provincia, S.A. de C.V., buscamos un desarrollo sostenible fundamentado en los siguientes elementos:</p>
            <h3>Medio Ambiente:</h3>
            <p> Define el compromiso de la empresa por impulsar acciones para el respeto y desarrollo sostenible con el medio ambiente, en beneficio de la sociedad.</p>
            <h3>Sociedad:</h3>
            <p> Promueve el compromiso de la empresa por el desarrollo y bienestar en las comunidades donde opera.</p>
            <h3>Gobernanza:</h3>
            <p> Establece y define las medidas para garantizar que las distintas áreas de la empresa trabajen en línea con la Ley y la ética empresarial.</p>
            <a href="/assets/pdf/PoliticaSostenibilidad.pdf" target="_blank" class="button">Consulta más detalle de nuestra Política de Sostenibilidad</a>    
        </div>
            </main>
